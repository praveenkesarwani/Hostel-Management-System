				...
				<form action="contact_manager.php" method="post">
					<div class="row">
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							...
							<div class="contact-fields-w3ls">
								<input type="text" name="student_roll_no" placeholder="Student ID Number" required="">
							</div>
							<div class="contact-fields-w3ls">
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="http://www.gbpuat.ac.in/" target="_blank">COT <span class="display"> PANTNAGAR</span></a>
		</div>
...
if(isset($_POST['submit'])){
	...
	VALUES ('$man_id','$roll','$hostel_id','$sender_name','$subject','$message','$today_date','$time')";
