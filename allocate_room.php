...
<body>
		...
		<div class="container">
			<div class="mail_grid_w3l">
				<form action="allocate_room.php" method="post">
					<div class="row">
						<div class="col-md-9">
							<input type="text" placeholder="Search by ID Number" name="search_box">
						</div>
						<div class="col-md-3">
   ...
   if (isset($_POST['search'])) {
	...
	/*echo "<script type='text/javascript'>
		alert('<?php echo $hostel_id; ?>')
	</script>";*/
	$query_search = "SELECT * FROM application WHERE Student_id like '$search_box%' and Hostel_id = '$hostel_id'
...
if(isset($_POST['submit'])){
   ...
   /*echo "<script type='text/javascript'>alert('<?php echo $room_no ?>')</script>";*/
	...
	$query2 = "SELECT * FROM room where Hostel_id ='$hostel_id' and  Room_No = (SELECT MIN(Room_No) FROM room 
				where (Allocated = '0')) ";
