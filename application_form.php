						...
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							...
							<div class="contact-fields-w3ls">
								<input type="text" name="id" placeholder="ID Number"
									value="<?php echo $_SESSION['id']?>" required="" disabled="disabled">
							</div>
							<div class="contact-fields-w3ls">
								<input type="text" name="hostel" placeholder="Hostel" value="<?php echo $_GET['id']?>"
	...
	<footer class="py-5">
		<div class="container py-md-5">
			<div class="footer-logo mb-5 text-center">
				<a class="navbar-brand" href="http://gbpuat.ac.in" target="_blank">COT <span class="display">
						PANTNAGAR</span></a>
			</div>
...
if(isset($_POST['submit'])){
	...
	$query_imp = "SELECT * FROM Student WHERE Student_id = '$student_id'";
	$result_imp = mysqli_query($conn,$query_imp);
	$row_imp = mysqli_fetch_assoc($result_imp);
	$room_id = $row_imp['Room_id'];
	
	/*echo "<script type='text/javascript'>
		alert('<?php echo $room_id ?>')
	</script>";*/
	
	if(is_null($room_id)){
		$query_imp2 = "SELECT * FROM Application WHERE Student_id = '$student_id'";
		...
		echo "<script type='text/javascript'>
			alert('You have Already applied for a Room')
		</script>";
	}
	}
	else{
	echo "<script type='text/javascript'>
		alert('You have Already been alloted a Room')
	</script>";
	}
}
?>